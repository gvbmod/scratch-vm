...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Hidden Blocks":"Salaiset lohkot"},"ko":{"_Hidden Blocks":"숨겨진 블록"},"nl":{"_Hidden Blocks":"Verborgen blokken"},"ru":{"_Hidden Blocks":"Скрытые Блоки"},"zh-cn":{"_Hidden Blocks":"隐藏积木块"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
