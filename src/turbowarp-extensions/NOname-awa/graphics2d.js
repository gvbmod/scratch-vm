...
/* generated l10n code */Scratch.translate.setup({"de":{"name":"Grafiken 2D"},"es":{"area":"área","diameter":"diámetro","name":"Gráficos 2D","radius":"radio"},"fi":{"area":"pinta-ala","circumference":"piiri","diameter":"halkaisija","graph":"verkon [graph] [CS]","line_section":"etäisyys pisteestä ([x1],[y1]) pisteeseen ([x2],[y2])","name":"2D-grafiikka","pi":"pii","quadrilateral":"neliön ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4]) [CS]","radius":"säde","ray_direction":"pisteiden ([x1],[y1]) ja ([x2],[y2]) välisen janan suunta","round":"ympyrän, jonka [rd] on [a], [CS]","triangle":"kolmion ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) [CS]","triangle_s":"kolmion [s1] [s2] [s3] pinta-ala"},"it":{"circumference":"circonferenza","diameter":"diametro","graph":"[CS] del grafo [graph]","line_section":"distanza tra ([x1],[y1]) e ([x2],[y2])","name":"Grafica 2D","pi":"pi greco","quadrilateral":"[CS] del quadrangolo ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4])","radius":"raggio","ray_direction":"direzione da ([x1],[y1]) a ([x2],[y2])","round":"[CS] del cerchio [rd][a]","triangle":"[CS] del triangolo ([x1],[y1]) ([x2],[y2]) ([x3],[y3])","triangle_s":"area del triangolo [s1] [s2] [s3]"},"ja":{"name":"グラフィック2D"},"ko":{"area":"넓이","diameter":"지름","line_section":"([x1],[y1]) 부터 ([x2],[y2]) 까지의 거리","name":"그래픽 2D","quadrilateral":"사각형 ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4]) 의 [CS]","radius":"반지름","ray_direction":"([x1],[y1]) 에서 ([x2],[y2]) 으로의 방향","triangle":"삼각형 ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) 의 [CS]","triangle_s":"삼각형 [s1] [s2] [s3] 의 넓이"},"nb":{"area":"område","circumference":"omkrets","graph":"graf [graph] 's [CS]","line_section":"lengde fra ([x1],[y1]) til ([x2],[y2])","name":"Grafikk 2D","quadrilateral":"firkant ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4]) 's [CS]","ray_direction":"retning av ([x1],[y1]) til ([x2],[y2])","round":"sirkel av [rd][a]'s [CS]","triangle":"trekant ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) 's [CS]","triangle_s":"trekant [s1] [s2] [s3] 's areal"},"nl":{"area":"oppervlakte","circumference":"omtrek","graph":"[CS] van grafiek [graph]","line_section":"lengte van ([x1],[y1]) naar ([x2],[y2])","name":"2D-trigonometrie","quadrilateral":"[CS] van vierhoek ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4])","radius":"straal","ray_direction":"richting van ([x1],[y1]) naar ([x2],[y2])","round":"[CS] van cirkel met [rd] [a]","triangle":"[CS] van driehoek ([x1],[y1]) ([x2],[y2]) ([x3],[y3])","triangle_s":"oppervlakte van driehoek [s1] [s2] [s3]"},"ru":{"area":"площадь","circumference":"длина","diameter":"диаметр","graph":"[CS] графа [graph]","line_section":"длина от ([x1],[y1]) до ([x2],[y2])","name":"Графика 2D","pi":"пи","quadrilateral":"[CS] четырехугольника ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4])","radius":"радиус","ray_direction":"направление от ([x1],[y1]) к ([x2],[y2])","round":"[CS] круга с [rd] ом [a]","triangle":"[CS] треугольника ([x1],[y1]) ([x2],[y2]) ([x3],[y3])","triangle_s":"площадь треугольника [s1] [s2] [s3]"},"tr":{"name":"Grafik 2D"},"zh-cn":{"area":"面积","circumference":"周长","diameter":"直径","graph":"图形 [graph] 的 [CS]","line_section":"（[x1],[y1]）到（[x2],[y2]）的长度","name":"图形 2D","pi":"π","quadrilateral":"矩形（[x1],[y1]）（[x2],[y2]）（[x3],[y3]）（[x4],[y4]）的 [CS]","radius":"半径","ray_direction":"（[x1],[y1]）的（[x2],[y2]）的距离","round":"[rd] 为 [a] 的圆的 [CS]","triangle":"三角形（[x1],[y1]）（[x2],[y2]）（[x3],[y3]）的 [CS]","triangle_s":"三角形 [s1] [s2] [s3] 的面积"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
  class graph {
    getInfo() {
      return {
