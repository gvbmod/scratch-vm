...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Link or data URI here":"Linkki tai data URI tähän","_all sprites":"kaikki hahmot","_brightness of [color]":"värin [color] kirkkaus","_delete costume [COSNAME] in [SPRITE]":"poista hahmon [SPRITE] asuste [COSNAME]","_delete sprite [SPRITE]":"poista hahmo [SPRITE]","_fps":"kuvataajuus","_import image from [TEXT] name [NAME]":"tuo kuva osoitteesta [TEXT] nimellä [NAME]","_import project from [TEXT]":"tuo projekti osoitteesta [TEXT]","_import sound from [TEXT] name [NAME]":"tuo ääni osoitteesta [TEXT] nimellä [NAME]","_import sprite from [TEXT]":"tuo hahmo osoitteesta [TEXT]","_list [TEXT] as array":"lista [TEXT] taulukkona","_load extension from [TEXT]":"lataa laajennus osoitteesta [TEXT]","_restart project":"käynnistä projekti uudelleen","_set editing target to [NAME]":"aseta muokkauksen kohteeksi [NAME]","_set list [NAME] to [TEXT]":"aseta lista [NAME] arvoon [TEXT]"},"ko":{"_Link or data URI here":"링크 또는 dataURI 입력","_all sprites":"모든 스프라이트","_brightness of [color]":"[color]의 밝기","_delete costume [COSNAME] in [SPRITE]":"[SPRITE]의 모양 [COSNAME] 삭제하기","_delete sprite [SPRITE]":"스프라이트 [SPRITE] 삭제하기","_import project from [TEXT]":"프로젝트를 [TEXT]에서 불러오기","_import sound from [TEXT] name [NAME]":"소리 [NAME]을(를) [TEXT]에서 불러오기 ","_import sprite from [TEXT]":"스프라이트를 [TEXT]에서 불러오기","_list [TEXT] as array":"리스트 [TEXT]을(를) 배열로","_load extension from [TEXT]":"확장 기능을 [TEXT]에서 불러오기","_set list [NAME] to [TEXT]":"리스트 [NAME]을(를) [TEXT](으)로 정하기"},"nl":{"_all sprites":"alle sprites"},"ru":{"_all sprites":"все спрайты"},"zh-cn":{"_Link or data URI here":"输入链接或dataURI","_all sprites":"所有角色","_brightness of [color]":"[color]的亮度","_delete costume [COSNAME] in [SPRITE]":"删除角色[SPRITE]的造型[COSNAME]","_delete sprite [SPRITE]":"删除角色[SPRITE]","_import image from [TEXT] name [NAME]":"从[TEXT]导入图片并命名为[NAME]","_import project from [TEXT]":"从[TEXT]导入项目","_import sound from [TEXT] name [NAME]":"从[TEXT]导入音频并命名为[NAME]","_import sprite from [TEXT]":"从[TEXT]导入角色","_list [TEXT] as array":"原版列表[TEXT]","_load extension from [TEXT]":"从[TEXT]加载拓展","_restart project":"重新运行作品","_set editing target to [NAME]":"将当前编辑角色设置为[NAME]","_set list [NAME] to [TEXT]":"设置原版列表[NAME]为[TEXT]"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
