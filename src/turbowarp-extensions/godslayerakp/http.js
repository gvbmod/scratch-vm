...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Hide Extra":"Piilota lisälohkot","_Request":"Pyyntö","_Response":"Vastaus","_Show Extra":"Näytä lisälohkot","_[name] from header":"[name] otsakkeesta","_[name] in request form":"pyyntölomakkeen [name]","_[path] in request options":"pyyntöasetusten [path]","_clear current data":"tyhjennä nykyiset tiedot","_delete [name] from request form":"poista [name] pyyntölomakkeesta","_error":"virhe","_headers as json":"otsakkeet JSON-muodossa","_in header set [name] to [value]":"aseta otsakkeen [name] arvoon [value]","_request failed?":"epäonnistuiko pyyntö?","_request succeeded?":"onnistuiko pyyntö?","_response":"vastaus","_send request to [url]":"lähetä pyyntö osoitteeseen [url]","_set [name] to [value] in request form":"aseta pyyntölomakkeen [name] arvoon [value]","_set [path] to [value] in request options":"aseta pyyntöasetusten [path] arvoon [value]","_set [path] to type [type] in request options":"aseta pyyntöasetusten kohteen [path] tyypiksi [type]","_set content type to [type]":"aseta sisällön tyypiksi [type]","_set headers to json [json]":"aseta otsakkeet JSON-koodiksi [json]","_set request body to [text]":"aseta pyynnön rungoksi [text]","_set request body to a form":"aseta pyynnön runko lomakkeeksi","_set request method to [method]":"aseta pyyntömenetelmäksi [method]","_site responded?":"vastasiko sivusto?","_status":"tila","_status text":"tilateksti","_type of [path] in request options":"pyyntöasetusten kohteen [path] tyyppi","_when a request fails":"kun pyyntö epäonnistuu","_when a site responds":"kun sivusto vastaa"},"it":{"_status":"stato"},"ko":{"_Request":"요청","_Response":"응답","_[name] from header":"헤더 [name]","_error":"오류","_headers as json":"헤더를 json으로","_in header set [name] to [value]":"헤더의 [name]을(를) [value](으)로 정하기","_request failed?":"요청이 실패했는가?","_request succeeded?":"요청이 성공했는가?","_response":"응답","_send request to [url]":"[url](으)로 요청 보내기  ","_set headers to json [json]":"헤더를 [json] json으로 정하기","_set request method to [method]":"요청 메소드를 [method](으)로 정하기","_site responded?":"사이트가 응답했는가?","_status text":"상태 메시지","_when a request fails":"요청이 실패했을 때","_when a site responds":"사이트가 응답했을 때"},"ru":{"_status":"статус"},"zh-cn":{"_Hide Extra":"隐藏更多","_Request":"请求","_Response":"响应","_Show Extra":"显示更多","_[name] from header":"请求头的[name]","_[name] in request form":"请求表单中的[name]","_[path] in request options":"请求选项的[path]","_clear current data":"清空当前数据","_delete [name] from request form":"从请求表单删除[name]","_error":"错误","_headers as json":"请求头json","_in header set [name] to [value]":"在请求头中设置[name]为[value]","_request failed?":"请求失败？","_request succeeded?":"请求成功？","_response":"响应","_send request to [url]":"发送请求给[url]","_set [name] to [value] in request form":"设置请求表单中的[name]为[value]","_set [path] to [value] in request options":"将请求选项中的[path]设为[value]","_set [path] to type [type] in request options":"将请求选项的[path]设为类型[type]","_set content type to [type]":"设置内容类型为[type]","_set headers to json [json]":"设置请求头为json[json]","_set request body to [text]":"设置请求体为[text]","_set request body to a form":"设置请求体为表单","_set request method to [method]":"设置请求方法为[method]","_site responded?":"网站响应？","_status":"封禁状态","_status text":"状态文本","_type of [path] in request options":"请求选项中[path]的类型","_when a request fails":"当有请求失败","_when a site responds":"当有网站响应"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
