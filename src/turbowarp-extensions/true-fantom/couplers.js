...
/* generated l10n code */Scratch.translate.setup({"de":{"_Couplers":"Coupler"},"fi":{"_Couplers":"Kytkimet","_angle [ANGLE]":"kulma [ANGLE]","_color [COLOUR]":"väri [COLOUR]","_false":"epätosi","_matrix [MATRIX]":"taulukko [MATRIX]","_note [NOTE]":"muistiinpano [NOTE]","_true":"tosi"},"it":{"_Couplers":"Adattatori"},"ja":{"_Couplers":"カプラ"},"ko":{"_Couplers":"커플러","_angle [ANGLE]":"방향 [ANGLE]","_color [COLOUR]":"색 [COLOUR]","_false":"거짓","_matrix [MATRIX]":"격자 [MATRIX]","_note [NOTE]":"음표 [NOTE]","_true":"참"},"nb":{"_Couplers":"Koblinger","_angle [ANGLE]":"vinkel [ANGLE]","_color [COLOUR]":"farge [COLOUR]","_matrix [MATRIX]":"matrise [MATRIX]","_note [NOTE]":"notat [NOTE]","_true":"sann"},"nl":{"_Couplers":"Koppelingen","_angle [ANGLE]":"richting [ANGLE]","_color [COLOUR]":"kleur [COLOUR]","_false":"onwaar","_note [NOTE]":"toon [NOTE]","_true":"waar"},"pl":{"_color [COLOUR]":"kolor [COLOUR]","_false":"fałsz"},"ru":{"_Couplers":"Муфта","_angle [ANGLE]":"угол [ANGLE]","_color [COLOUR]":"цвет [COLOUR]","_false":"нет","_matrix [MATRIX]":"матрица [MATRIX]","_note [NOTE]":"нота [NOTE]","_true":"да"},"zh-cn":{"_Couplers":"耦合器","_angle [ANGLE]":"角度[ANGLE]","_color [COLOUR]":"颜色[COLOUR]","_false":"假","_matrix [MATRIX]":"矩阵[MATRIX]","_note [NOTE]":"音符[NOTE]","_true":"真"}});/* end generated l10n code */((Scratch) => {
  "use strict";
