...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Hello!":"Terve!","_Numerical Encoding V1":"Numerosalaus V1","_decode [ENCODED] back to text":"pura [ENCODED] tekstiksi","_decoded":"purettu","_encode [DATA] to numbers":"salaa [DATA] numeroiksi","_encoded":"salattu"},"it":{"_Hello!":"Ciao!","_Numerical Encoding V1":"Codifica Numerica V1","_decoded":"decodificato","_encoded":"codificato"},"ja":{"_Hello!":"こんにちは!"},"ko":{"_Hello!":"안녕!","_Numerical Encoding V1":"숫자 인코딩 V1","_decode [ENCODED] back to text":"[ENCODED]을(를) 텍스트로 디코딩하기","_encode [DATA] to numbers":"[DATA]을(를) 숫자로 인코딩하기","_encoded":"인코딩"},"nb":{"_Hello!":"Hei!","_Numerical Encoding V1":"Numerisk Koding V1","_decoded":"dekodet","_encoded":"kodet"},"nl":{"_Hello!":"Hallo!","_Numerical Encoding V1":"Numerieke codering V1","_decoded":"gedecodeerd","_encoded":"gecodeerd"},"pl":{"_Hello!":"Cześć!"},"ru":{"_Hello!":"Привет!","_Numerical Encoding V1":"Численная Кодировка V1","_decoded":"декодированное","_encoded":"закодированное"},"zh-cn":{"_Hello!":"你好！","_Numerical Encoding V1":"数字编码 V1","_decode [ENCODED] back to text":"解密[ENCODED]回文字","_decoded":"解码数据","_encode [DATA] to numbers":"加密[DATA]为数字","_encoded":"编码数据"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
