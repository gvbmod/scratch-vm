...
class NesEmulator {
            ...
            blocks: [
				{
					...
					xml: "<sep gap='6'/><label text='Only direct URLS will work for'/><sep gap='-12'/><label text='NES roms. I do not recommend using'/><sep gap='-12'/><label text='copyrighted NES roms.'/><sep gap='-12'/><label text='Piracy is illegal, and even.'/><sep gap='-12'/><label text='with NES games'/><sep gap='24'/>",
				},
				{
                    opcode: "cleanVars",
    ...
    showScreen(args, util) {
        ...
        this.renderer.updateDrawableSkinId(target.drawableID, nesSkin._id);
